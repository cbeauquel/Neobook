 ...
 */
final class Version20250104200538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bo_co_si ADD CONSTRAINT FK_9D818E0D16A2B381 FOREIGN KEY (book_id) REFERENCES book (id)');
        $this->addSql('ALTER TABLE bo_co_si ADD CONSTRAINT FK_9D818E0D7A19A357 FOREIGN KEY (contributor_id) REFERENCES contributor (id)');
        $this->addSql('ALTER TABLE bo_co_si ADD CONSTRAINT FK_9D818E0D5585C142 FOREIGN KEY (skill_id) REFERENCES skill (id)');
    }
