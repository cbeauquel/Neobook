 ...
 */
final class Version20250110194501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bo_sk_co ADD book_id INT NOT NULL, ADD contributor_id INT NOT NULL, ADD skill_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bo_sk_co DROP book_id, DROP contributor_id, DROP skill_id');
    }
}
